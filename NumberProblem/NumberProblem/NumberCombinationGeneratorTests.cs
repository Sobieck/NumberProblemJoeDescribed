...
{
    [TestClass]
    public class NumberCombinationGeneratorTests
    {
        private NumberCombinationGenerator numberGenerator;
        private List<List<int>> expected;

        public NumberCombinationGeneratorTests()
        {
            numberGenerator = new NumberCombinationGenerator();
        }
